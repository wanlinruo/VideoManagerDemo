package com.tuya.smart.videomanagerdemo.ui
...
import com.tuya.smart.videomanagerdemo.Config.Companion.minSelection
import com.tuya.smart.videomanagerdemo.R
import com.tuya.smart.videomanagerdemo.decodeFile
...
//        Log.d(TAG, "adjustProgressBar  transX_:$transX_, transX: $transX")
    ...
    fun init(context: Context) {
        ...
        shadowPaint.style = Paint.Style.FILL
        minDistance =
            context.resources.getDimensionPixelSize(R.dimen.video_clip_min_length).toFloat()
        progressWidth =
        ...
        with(context.resources) {
            ...
            framebarPadding =
                getDimensionPixelSize(R.dimen.clip_frame_bar_width_outer) - getDimensionPixelSize(R.dimen.clip_frame_bar_width)
